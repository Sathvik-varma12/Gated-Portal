...
const Visitors: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h2 className="text-2xl font-bold text-gray-800 mb-6"> Visitor</h2>
      <Breadcrumb />
